...
class Hyperparameters:
    ...
    ttt_perlayer = bool(int(os.environ.get("TTT_PERLAYER", "0")))  # per-group LR scaling
...
def eval_val_sliding_ttt(
    ...
    if args.ttt_optimizer == "adamw" and args.ttt_perlayer:
        # Per-group LR: mlp_down_bank 3x, qo/kv_bank 0.5x, others 1x
        grp_down, grp_attn, grp_other = [], [], []
        for name, p in base_model.named_parameters():
            ...
            if "mlp_down_bank" in name:
                ...
                grp_other.append(p)
        param_groups = [
            {"params": grp_down, "lr": args.ttt_lr * 3.0, "initial_lr": args.ttt_lr * 3.0},
            {"params": grp_attn, "lr": args.ttt_lr * 0.5, "initial_lr": args.ttt_lr * 0.5},
            {"params": grp_other, "lr": args.ttt_lr, "initial_lr": args.ttt_lr},
        ]
