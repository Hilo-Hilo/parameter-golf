...
class Hyperparameters:
    ...
    ttt_optimizer: str = os.environ.get("TTT_OPTIMIZER", "sgd")
    ttt_const_lr: bool = bool(int(os.environ.get("TTT_CONST_LR", "0")))
    lzma_preset: int = int(os.environ.get("LZMA_PRESET", "6"))
