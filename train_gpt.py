    ...
    for ci in range(num_chunks):
        ...
        if not is_last_chunk and args.ttt_epochs > 0:
            ...
            if chunk_seqs > 0:
                ...
                # Fresh AdamW optimizer per chunk: prevents stale second moments from
                # early chunks from suppressing adaptation in later chunks.
                optimizer = torch.optim.AdamW(ttt_params, lr=cos_lr, betas=(0.9, 0.999), weight_decay=0)
