    ...
    for name, p in base_model.named_parameters():
        ...
        if freeze:
            ...
            if 'mlp_up_bank' in name or 'mlp_down_bank' in name:
                ...
                attn_ttt_params.append(p)
            else:
                other_ttt_params.append(p)
    ttt_params = mlp_ttt_params + attn_ttt_params + other_ttt_params
    ...
    if args.ttt_optimizer == "adamw":
        if args.ttt_perlayer_lr:
            optimizer = torch.optim.AdamW([
                {"params": mlp_ttt_params, "lr": args.ttt_lr * 3.0, "base_lr": args.ttt_lr * 3.0},
                {"params": attn_ttt_params, "lr": args.ttt_lr * 0.5, "base_lr": args.ttt_lr * 0.5},
