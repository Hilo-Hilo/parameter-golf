...
class Hyperparameters:
    ...
    ttt_reset_m1_chunk = bool(int(os.environ.get("TTT_RESET_M1_CHUNK", "0")))
        ...
        if not is_last_chunk and args.ttt_epochs > 0:
            ...
            if chunk_seqs > 0:
                ...
                for pg in optimizer.param_groups:
                    pg['lr'] = cos_lr
                # Per-chunk m1 reset: zero first moment while preserving second moment (curvature).
                # This ensures gradient direction is chunk-local while retaining accumulated LR scaling.
                if args.ttt_reset_m1_chunk and args.ttt_use_adamw:
                    for p in ttt_params:
