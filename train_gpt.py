...
def eval_val_sliding_ttt(
    ...
    if args.ttt_perlayer_lr and args.ttt_optimizer == "adamw":
        # Build per-layer parameter groups: MLP params at higher LR, attn at lower LR
        ...
        param_groups = [
            {"params": mlp_params, "lr": args.ttt_lr * args.ttt_mlp_lr_scale,
             "base_lr": args.ttt_lr * args.ttt_mlp_lr_scale},
            {"params": attn_params, "lr": args.ttt_lr * args.ttt_attn_lr_scale,
             "base_lr": args.ttt_lr * args.ttt_attn_lr_scale},
            {"params": other_params, "lr": args.ttt_lr,
             "base_lr": args.ttt_lr},
        ]
        optimizer = torch.optim.AdamW(param_groups, weight_decay=0.0)
        log0(f"ttt_sliding:adamw_perlayer mlp_lr={args.ttt_lr * args.ttt_mlp_lr_scale:.4f} "
             f"attn_lr={args.ttt_lr * args.ttt_attn_lr_scale:.4f} base_lr={args.ttt_lr:.4f}")
        ...
        for pg in optimizer.param_groups:
            pg['base_lr'] = args.ttt_lr
        log0(f"ttt_sliding:sgd lr={args.ttt_lr:.4f} momentum={args.ttt_momentum:.4f}")
