...
class Hyperparameters:
    ...
    ttt_adam_b1 = float(os.environ.get("TTT_ADAM_B1", 0.9))
    ttt_adam_b2 = float(os.environ.get("TTT_ADAM_B2", 0.999))
...
def eval_val_sliding_ttt(
    ...
    if args.ttt_use_adamw:
        optimizer = torch.optim.AdamW(ttt_params, lr=args.ttt_lr,
                                      betas=(args.ttt_adam_b1, args.ttt_adam_b2),
                                      weight_decay=args.ttt_adam_wd)
    else:
