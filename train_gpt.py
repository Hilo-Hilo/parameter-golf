...
class Hyperparameters:
    ...
    trigram_vocab_size = int(os.environ.get("TRIGRAM_VOCAB_SIZE", 3072))
...
class TrigramHashEmbedding(nn.Module):
    ...
    def trigram_hash(self, tokens: Tensor) -> Tensor:
        ...
        out[..., 2:] = torch.bitwise_xor(
            torch.bitwise_xor(51839 * t[..., 2:], 36313 * t[..., 1:-1]),
            27191 * t[..., :-2]
        ) % mod
        return out.long()
    def forward(self, token_ids: Tensor) -> Tensor:
...
def main() -> None:
    ...
    quant_result, quant_meta = mixed_quantize_int6(unbanked_sd, {"mlp", "attn", "bigram", "trigram"})
