...
class Hyperparameters:
    ...
    mlp_quant_bits = int(os.environ.get("MLP_QUANT_BITS", 6))
...
def mixed_quantize_int6(state_dict: dict[str, Tensor], int6_cats: set[str], mlp_clip_range: int = 31):
...
def main() -> None:
    ...
    mlp_clip_range = 15 if args.mlp_quant_bits == 5 else 31
    quant_result, quant_meta = mixed_quantize_int6(unbanked_sd, {"mlp", "attn"}, mlp_clip_range=mlp_clip_range)
