...
def mixed_quantize_int6(state_dict: dict[str, Tensor], int6_cats: set[str], int5_cats=None):
...
def main() -> None:
    ...
    int5_cats_q = {"mlp"} if args.int5_mlp else set()
    quant_result, quant_meta = mixed_quantize_int6(unbanked_sd, {"mlp", "attn"}, int5_cats=int5_cats_q)
