...
class Hyperparameters:
    ...
    ttt_lr_floor_frac = float(os.environ.get("TTT_LR_FLOOR_FRAC", 0.0))
...
def eval_val_sliding_ttt(
    ...
    for ci in range(num_chunks):
        ...
        if not is_last_chunk and args.ttt_epochs > 0:
            ...
            if chunk_seqs > 0:
                cos_lr_raw = args.ttt_lr * 0.5 * (1.0 + math.cos(math.pi * ci / max(num_chunks - 1, 1)))
                cos_lr = max(cos_lr_raw, args.ttt_lr * args.ttt_lr_floor_frac)
