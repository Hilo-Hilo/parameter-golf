...
- Assume this machine is a controller-only environment for Parameter Golf: training and heavy experiment execution should run on RunPod, with GitHub used as the sync point for exact worker commits.
